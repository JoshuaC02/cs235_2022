...
class TestArtist:
    ...
    def test_construction(self):  # TODO
...
class TestAlbum:
    ...
    def test_attributes(self):  # Passes
        album1 = Album(15, 'Justice')
...
class TestTrack:
    ...
    def test_attributes_fail(self):  # Passes
        track1 = Track(1, 'Shivers')
        track2 = Track(2, 'Heat Waves')
    ...
    def test_genre_methods(self):  # Passes
        track1 = Track(1, 'Shivers')
...
class TestReview:  # TODO - passes but check method

    def test_construction(self):  # Passes
...
class TestUser:
    ...
    def test_track_methods(self):  # Passes
    ...
    def test_review_methods(self):  # Passes
...
class TestCSVReader:
    ...
    def test_csv_reader(self):  # Passes
    ...
    def test_tracks_dataset(self):  # Passes
        reader = create_csv_reader()
    ...
    def test_albums_dataset(self):  # Passes
        reader = create_csv_reader()
    ...
    def test_artists_dataset(self):  # Passes
        reader = create_csv_reader()
    ...
    def test_genres_dataset(self):  # Passes
        reader = create_csv_reader()
